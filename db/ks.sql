...
MySQL - 5.1.56-community : Database - ks
*********************************************************************
*/
...
CREATE DATABASE /*!32312 IF NOT EXISTS*/`ks` /*!40100 DEFAULT CHARACTER SET latin1 */;
...
INSERT INTO `ks`.`job` (`job_id`, `jobName`) VALUES (NULL, 'BOF'); 
INSERT INTO `ks`.`job` (`job_id`, `jobName`) VALUES (NULL, 'LHF'); 
INSERT INTO `ks`.`job` (`job_id`, `jobName`) VALUES (NULL, 'RHD'); 
